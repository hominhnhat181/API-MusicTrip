		...
		<div class="modal-content h-100">
			...
			<div class="modal-footer justify-content-between bg-light" >
				<div class="flex-grow-1 overflow-hidden d-flex">
					...
					<div class="mb-0 ml-3">
						<button type="button" class="btn btn-sm btn-primary reset" id="uploader_prev_btn">{{ translate('Prev') }}</button>
						<button type="button" class="btn btn-sm btn-primary reset" id="uploader_next_btn">{{ translate('Next') }}</button>
					</div>
				</div>
				<button type="button" class="btn btn-sm btn-primary reset" data-toggle="aizUploaderAddSelected">{{ translate('Save') }}</button>
			</div>
		</div>
	</div>
</div>
