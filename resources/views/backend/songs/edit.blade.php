    ...
    <div class="row">
        <div class="col-lg-8 mx-auto create-form">
            <div class="card customer-form">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('admin.song.update', $song->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf {{method_field('PUT')}}
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label">{{ translate('Name') }}
                                <span class="text-danger">*</span></label>
                            <div class="col-md-9">
                                <input type="text" placeholder="{{ translate('Name') }}" value="{{$song->name}}" id="name" name="name"
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label" for="signinSrEmail">{{ translate('Tracks') }}</label>
                            <div class="col-md-9">
                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text bg-soft-secondary font-weight-medium">
                                    ...
                                    <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                    <input type="hidden" value="{{ $file->id ?? 0 }}" name="song" class="selected-files">
                                </div>
                                {{-- review upload Image --}}
                                <div class="file-preview box sm">
                                </div>
                        ...
                        <div class="form-group row align-items-baseline">
                            ...
                            <div class="col-lg-9">
                                <select required name="artist_id" data-selected="{{$song->artist_id}}" id="artist_id" class="mb-2 form-control aiz-selectpicker" >
                        ...
                        <div class="form-group row align-items-baseline">
                            <label class="col-lg-3 col-from-label" for="type">{{translate('Feature')}} <span class="text-danger">*</span></label>
                            <div class="col-lg-9">
                                <select required name="album_id" data-selected="{{$song->album_id}}" id="album_id" class="mb-2 form-control aiz-selectpicker" >
                        ...
                        <div class="form-group row align-items-baseline">
                            <label class="col-lg-3 col-from-label" for="type">{{translate('Feature')}} <span class="text-danger">*</span></label>
                            <div class="col-lg-9">
                                <select required name="tag_id" data-selected="{{$song->tag_id}}" id="tag_id" class="mb-2 form-control aiz-selectpicker" >
                        ...
                        <div class="form-group mb-0 text-right">
                            <button class="btn btn-light"><a href="{{route('admin.song.index')}}">{{ translate('Cancel') }}</a></button>
