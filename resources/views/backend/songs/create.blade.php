                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('admin.song.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                    ...
                                    <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                    <input type="hidden" name="song" class="selected-files">
                                </div>
                                {{-- review upload Image --}}
                                <div class="file-preview box sm">
                                </div>
                        ...
                        <div class="form-group row align-items-baseline">
                            ...
                            <div class="col-lg-9">
                                <select required name="artist_id" id="artist_id" class="mb-2 form-control aiz-selectpicker" >
                        ...
                        <div class="form-group row align-items-baseline">
                            <label class="col-lg-3 col-from-label" for="type">{{translate('Feature')}} <span class="text-danger">*</span></label>
                            <div class="col-lg-9">
                                <select required name="album_id" id="album_id" class="mb-2 form-control aiz-selectpicker" >
