    ...
    <div class="row">
        <div class="col-lg-8 mx-auto create-form">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('admin.artist.update', $artist->id) }}" method="POST"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" value="{{$artist->name}}" type="text" placeholder="{{ translate('Name') }}" id="name" name="name"  required>
                                @error('name')
                        ...
                        <div class="form-group row align-items-baseline">
                            ...
                            <div class="col-lg-9">
                                <select required name="status" id="status" data-selected="{{$artist->status}}" class="mb-2 form-control aiz-selectpicker" >
