                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('admin.album.update', $album->id) }}" method="POST"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" type="text" value="{{$album->name}}" placeholder="{{$album->name}}" id="name" name="name"  required>
                                @error('name')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <textarea name="desc" rows="5" class="form-control text-area">{{$album->desc}}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row align-items-baseline">
                            ...
                            <div class="col-lg-9">
                                <select required name="status" id="status" class="mb-2 form-control aiz-selectpicker" data-selected="{{$album->status}}">
                        ...
                        <div class="form-group row align-items-baseline">
                            ...
                            <div class="col-lg-9">
                                <select required name="feature_id" id="feature_id" data-selected="{{$album->feature_id}}" class="mb-2 form-control aiz-selectpicker" >
