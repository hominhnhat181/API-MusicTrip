    ...
    <div class="d-xl-none d-flex">
        ...
        <div class="aiz-topbar-logo-wrap d-flex align-items-center justify-content-start">
            <a href="{{ route('admin.dashboard') }}" class="d-block">
                <img src="{{static_asset('assets/backend/img/logo.jpg')}}" class="brand-icon object-fit-contain" alt="Rehau">
            </a>
        </div>
    </div>
            ...
            <div class="aiz-topbar-item ml-2">
                <div class="align-items-stretch d-flex dropdown">
                    <a class="dropdown-toggle no-arrow text-dark" data-toggle="dropdown" href="javascript:void(0);" role="button" aria-haspopup="false" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <span class="avatar avatar-sm mr-md-2">
                                <img src="{{static_asset('assets/backend/img/avatar-place.png')}}"
                                    onerror="this.onerror=null;this.src='{{static_asset('assets/backend/img/avatar-place.png')}}';" >
                            </span>
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-menu-md">
                        ...
                        <form action="{{ route('admin.logout')}}" method="get" id="logout-form">
                            @csrf  
                            <a href="javascript:document.querySelector('#logout-form').submit()"  class="dropdown-item">
